...
, "form.text.location.3": "TH"
		...
		window.addEventListener("DOMContentLoaded", () => {
    		const videoElement = document.getElementById("playContent_1");
    		videoElement.muted = false; // Ensure the muted property is false
		});
		window.addEventListener("DOMContentLoaded", () => {
    		const videoElement = document.getElementById("playContent_2");
    		videoElement.muted = false; // Ensure the muted property is false
		});
		window.addEventListener("DOMContentLoaded", () => {
    		const videoElement = document.getElementById("playContent_3");
    		videoElement.muted = false; // Ensure the muted property is false
		});
							...
							<div id="streamContainer_1" class="video">
								...
								<div id='canvasDiv_1'>
									...
									<div class="video-container" id="mobileVideoDiv">
										...
										<video id="playContent_1" playsinline autoplay width="100%"
											   height="100%"></video>
								...
								<div id='canvasDiv_2'>
									<div id='streamMessage_2' style='display:none;'></div>
										<div class="video-container" id="mobileVideoDiv">
											...
											<video id="playContent_2" playsinline autoplay width="100%"
												   height="100%"></video>
							...
							<div id="streamContainer_3" class="video">
								...
								<div id='canvasDiv_3'>
									<div id='streamMessage_3' style='display:none;'></div>
										...
										<video id="playContent_3" playsinline autoplay width="100%"
											   height="100%"></video>
